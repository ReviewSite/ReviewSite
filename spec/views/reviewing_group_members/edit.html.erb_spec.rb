...
describe "reviewing_group_members/edit" do
  ...
  it "renders the edit reviewing_group_member form" do
    ...
    assert_select "form", :action => reviewing_group_members_path(@reviewing_group_member), :method => "post" do
      assert_select "select#reviewing_group_member_reviewing_group_id", :name => "reviewing_group_member[reviewing_group_id]"
      assert_select "select#reviewing_group_member_user_id", :name => "reviewing_group_member[user_id]"
    end
  end
end
