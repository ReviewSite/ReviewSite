...
describe SelfAssessmentsController do
  ...
  # SelfAssessmentsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all self_assessments as @self_assessments" do
      self_assessment = SelfAssessment.create! valid_attributes
      get :index, {}, valid_session
      assigns(:self_assessments).should eq([self_assessment])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested self_assessment as @self_assessment" do
      self_assessment = SelfAssessment.create! valid_attributes
      get :show, {:id => self_assessment.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested self_assessment as @self_assessment" do
      self_assessment = SelfAssessment.create! valid_attributes
      get :edit, {:id => self_assessment.to_param}, valid_session
      assigns(:self_assessment).should eq(self_assessment)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new SelfAssessment" do
        expect {
          post :create, {:self_assessment => valid_attributes}, valid_session
      ...
      it "redirects to the created self_assessment" do
        post :create, {:self_assessment => valid_attributes}, valid_session
        response.should redirect_to(SelfAssessment.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved self_assessment as @self_assessment" do
        ...
        post :create, {:self_assessment => {}}, valid_session
        assigns(:self_assessment).should be_a_new(SelfAssessment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested self_assessment" do
        ...
        put :update, {:id => self_assessment.to_param, :self_assessment => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested self_assessment as @self_assessment" do
        self_assessment = SelfAssessment.create! valid_attributes
        put :update, {:id => self_assessment.to_param, :self_assessment => valid_attributes}, valid_session
        assigns(:self_assessment).should eq(self_assessment)
      end
      ...
      it "redirects to the self_assessment" do
        self_assessment = SelfAssessment.create! valid_attributes
        put :update, {:id => self_assessment.to_param, :self_assessment => valid_attributes}, valid_session
        response.should redirect_to(self_assessment)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the self_assessment as @self_assessment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SelfAssessment.any_instance.stub(:save).and_return(false)
        put :update, {:id => self_assessment.to_param, :self_assessment => {}}, valid_session
        assigns(:self_assessment).should eq(self_assessment)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested self_assessment" do
      self_assessment = SelfAssessment.create! valid_attributes
      expect {
        delete :destroy, {:id => self_assessment.to_param}, valid_session
      }.to change(SelfAssessment, :count).by(-1)
    end
    ...
    it "redirects to the self_assessments list" do
      self_assessment = SelfAssessment.create! valid_attributes
      delete :destroy, {:id => self_assessment.to_param}, valid_session
      response.should redirect_to(self_assessments_url)
    end
  end
