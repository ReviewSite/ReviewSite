class Review < ActiveRecord::Base
  ...
  def questions
    ...
    # new-style questions
    questions["Role Competence"] = Question.new("Role Competence", "Role Competence", ["role_competence_went_well", "role_competence_to_be_improved", "role_competence_action_items"],
    ...
    questions["Consulting Skills"] = Question.new("Consulting Skills", "Consulting Skills", ["consulting_skills_went_well", "consulting_skills_to_be_improved", "consulting_skills_action_items"],
  ...
  def headers
    headings.collect {|heading| questions[heading].fields}.flatten
  end
