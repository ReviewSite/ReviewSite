  ...
  describe "POST create" do
    describe "with valid record" do
      it "saves the record" do
        post :create, username: "test", review_id: review.id
        Invitation.last.email.should == "test@thoughtworks.com"
      end

      it "sends an email with correct details" do
        ActionMailer::Base.deliveries.clear
        post :create, username: "test", review_id: review.id, message: "This is the custom message"
      ...
      it "doesn't send an email if params[:no_email] is passed" do
        ActionMailer::Base.deliveries.clear
        post :create, username: "test", review_id: review.id, no_email: '1'
    ...
    describe "with invalid record" do
      it "does not save the record" do
        expect do
          post :create, username: "!!!invalid!!!", review_id: review.id
